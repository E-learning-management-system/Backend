# Generated by Django 3.2.4 on 2022-06-13 16:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_login', models.DateTimeField(auto_now_add=True, null=True, verbose_name='آخرین ورود')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(default=None, verbose_name='تاریخ آغاز')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(blank=True, default=None, max_length=50, null=True, verbose_name='موضوع')),
                ('description', models.TextField(verbose_name='متن')),
                ('date', models.DateTimeField(auto_now_add=True, null=True, verbose_name='تاریخ')),
                ('file', models.FileField(blank=True, default=None, help_text='Image size should be less than 1.0\xa0MB', null=True, upload_to=master.models.post_image_directory_path, validators=[django.core.validators.FileExtensionValidator(['png', 'jpg', 'jpeg']), master.models.validate_image_size], verbose_name='فایل')),
                ('savedby', models.ManyToManyField(blank=True, to=settings.AUTH_USER_MODEL, verbose_name='ذخیره شده توسط: ')),
            ],
            options={
                'verbose_name': 'پست',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teacher', models.ForeignKey(limit_choices_to={'type': 't'}, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='استاد')),
            ],
            options={
                'verbose_name': 'تمرین',
