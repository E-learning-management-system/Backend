...
urlpatterns = [
    ...
    path('exercises/<int:pk>/newanswer/', ms.AnswerCreate.as_view()),
    ...
    path('exercise/<int:pk>', ms.StudentAnswerCheck.as_view()),
    path('courses/<int:coursepk>/students/<int:pk>', ms.CourseStudentDelete.as_view()),
]
